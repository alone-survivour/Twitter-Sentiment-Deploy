...
def main():
    ...
    <div style="background-color:darkturquoise; padding:10px">
        <h2 style="color: white; text-align: center;">Tweet Sentimental Analyser Project with Streamlit</h2>
    </div>
    """
    ...
    if choice == "About":
        ...
        st.subheader("Powered by Streamlit! A fastest way to deploy your data science apps")
